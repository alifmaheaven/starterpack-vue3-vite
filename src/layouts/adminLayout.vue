  ...
  >
    <div class="h-full overflow-y-auto">
      ...
      <ul class="space-y-2 tracking-wide mt-8">
        <li class="bg-gray-300 rounded-xl p-1">
          <a
            href="#"
            aria-label="dashboard"
            class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-primary"
          >
            <icon-ic-baseline-3p/>
          ...
          <ul class="my-1 ml-4 space-y-2">
            <li class="my-1">
              ...
              >
                ...
                <span class="-mr-1 font-medium">Child Item</span>
              </a>
            </li>
          </ul>
        </li>
